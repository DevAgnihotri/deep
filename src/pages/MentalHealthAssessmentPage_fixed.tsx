      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <TabsContent value="overview" className="space-y-6">
              ...
              <div className="relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
                  ...
                  <div className="bg-white bg-opacity-80 backdrop-blur-sm p-6 rounded-2xl shadow-lg border border-purple-100">
                    ...
                    <h4 className="font-bold text-purple-900 mb-2">TensorFlow.js</h4>
                    <p className="text-sm text-purple-800">Advanced AI models running directly in your browser</p>
                  </div>
                  ...
                  <div className="bg-white bg-opacity-80 backdrop-blur-sm p-6 rounded-2xl shadow-lg border border-green-100">
                    ...
                    <h4 className="font-bold text-green-900 mb-2">Clinical Validation</h4>
                    <p className="text-sm text-green-800">Evidence-based assessments validated by mental health professionals</p>
                  </div>
                  
                  <div className="bg-white bg-opacity-80 backdrop-blur-sm p-6 rounded-2xl shadow-lg border border-orange-100">
                    <div className="w-12 h-12 bg-orange-500 rounded-full flex items-center justify-center mx-auto mb-3">
                      <Zap className="w-6 h-6 text-white" />
                    </div>
                    <h4 className="font-bold text-orange-900 mb-2">Real-time Analysis</h4>
                    <p className="text-sm text-orange-800">Instant processing and personalized recommendations</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <Card className="relative overflow-hidden border-2 border-blue-200 hover:border-blue-300 hover:shadow-xl transition-all duration-300 group">
              ...
              <CardHeader className="relative z-10 pb-4">
                <div className="flex items-center space-x-4 mb-4">
                  ...
                  <div>
                    <CardTitle className="text-2xl font-bold text-blue-900">Depression Assessment</CardTitle>
                    <CardDescription className="text-base text-blue-700">PHQ-9 Clinical Screening</CardDescription>
                  </div>
                </div>
              </CardHeader>
              <CardContent className="relative z-10 space-y-4">
                <div className="bg-blue-50 p-4 rounded-xl border border-blue-200">
                  <h4 className="font-semibold text-blue-900 mb-2">AI-Enhanced Features:</h4>
                  <ul className="text-sm text-blue-800 space-y-1">
                    <li>• Neural network pattern analysis</li>
                    <li>• Real-time risk assessment</li>
                    <li>• Clinically validated scoring</li>
                    <li>• Personalized recommendations</li>
                  </ul>
                </div>
                <Button 
                  onClick={() => setActiveTab('depression')}
                  className="w-full h-12 text-lg bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 shadow-lg"
                >
            ...
            {/* Lifestyle Assessment Card */}
            <Card className="relative overflow-hidden border-2 border-purple-200 hover:border-purple-300 hover:shadow-xl transition-all duration-300 group">
              ...
              <CardHeader className="relative z-10 pb-4">
                <div className="flex items-center space-x-4 mb-4">
                  ...
                  <div>
                    ...
                    <CardDescription className="text-base text-purple-700">Risk Factor Analysis</CardDescription>
                  </div>
                </div>
              </CardHeader>
              <CardContent className="relative z-10 space-y-4">
                <div className="bg-purple-50 p-4 rounded-xl border border-purple-200">
                  ...
                  <ul className="text-sm text-purple-800 space-y-1">
                    <li>• Lifestyle risk prediction</li>
                    <li>• Environmental factor assessment</li>
                    <li>• Behavioral pattern recognition</li>
                    <li>• Tailored intervention strategies</li>
                  </ul>
                </div>
                <Button 
            ...
            <Card className="border-2 border-green-200 bg-gradient-to-r from-green-50 to-emerald-50">
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className={`p-4 rounded-xl border-2 ${depressionResult ? 'bg-green-100 border-green-300' : 'bg-gray-100 border-gray-300'}`}>
                    <div className="flex items-center space-x-2">
                      <Brain className={`h-5 w-5 ${depressionResult ? 'text-green-600' : 'text-gray-400'}`} />
                      <span className={`font-medium ${depressionResult ? 'text-green-800' : 'text-gray-600'}`}>
                        Depression Assessment
                      </span>
                    </div>
                    <div className="text-sm mt-1 text-gray-600">
                      {depressionResult ? 'Completed' : 'Pending'}
                    </div>
                  </div>
                  
                  <div className={`p-4 rounded-xl border-2 ${personalityResult ? 'bg-green-100 border-green-300' : 'bg-gray-100 border-gray-300'}`}>
                    <div className="flex items-center space-x-2">
                      <User className={`h-5 w-5 ${personalityResult ? 'text-green-600' : 'text-gray-400'}`} />
                      <span className={`font-medium ${personalityResult ? 'text-green-800' : 'text-gray-600'}`}>
                        Lifestyle Assessment
                      </span>
                    </div>
                    <div className="text-sm mt-1 text-gray-600">
                      {personalityResult ? 'Completed' : 'Pending'}
                    </div>
                  </div>
                  
                  <div className="p-4 rounded-xl border-2 bg-blue-100 border-blue-300">
                    <div className="flex items-center space-x-2">
              ...
              <div className="space-y-8">
                ...
                <Card className="border-0 shadow-2xl bg-gradient-to-br from-gray-50 to-white">
                  <CardContent className="p-8">
                    <div className="text-center space-y-6">
                      <div className="inline-flex items-center gap-4 p-8 rounded-2xl bg-gradient-to-br from-blue-50 via-purple-50 to-indigo-50 border-2 border-blue-100 shadow-lg">
                        <div className="text-center">
                          <div className="flex items-center justify-center mb-3">
                            <Activity className="w-6 h-6 text-blue-600 mr-2" />
                            <span className="text-lg font-semibold text-gray-800">AI Risk Assessment</span>
                          </div>
                ...
                <div className="grid lg:grid-cols-2 gap-8">
                  {/* Depression Results */}
                  {displayResults.depression && (
                    <Card className="border-0 shadow-xl bg-gradient-to-br from-blue-50 to-blue-100 overflow-hidden">
                          ...
                          <div className="flex items-center justify-between mb-4">
                            <div className="flex items-center space-x-3">
                              ...
                              <div>
                                ...
                                <p className="text-blue-100">PHQ-9 Clinical Analysis</p>
                              </div>
                            </div>
                            <div className="bg-white bg-opacity-20 px-3 py-1 rounded-full">
                              <span className="text-sm font-semibold">AI-Analyzed</span>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <CardContent className="p-8 space-y-6">
                        ...
                        <div className="text-center p-6 bg-white rounded-2xl shadow-lg">
                          ...
                          <div className="text-sm text-gray-600">Clinical Depression Score</div>
                        </div>
                        ...
                        {displayResults.depression.aiPrediction && (
                          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-2xl border-2 border-blue-100">
                            ...
                            <div className="bg-white p-4 rounded-xl shadow-sm">
                              <div className="text-sm text-gray-600 mb-2">Neural Network Classification:</div>
                              <div className="text-lg font-semibold text-blue-800">
                                {displayResults.depression.aiPrediction.class}
                              </div>
                              <div className="text-xs text-gray-500 mt-2">
                                Analyzed using advanced TensorFlow.js models
                              </div>
                            </div>
                          </div>
                        )}
                ...
                <Card className="border-0 shadow-2xl bg-gradient-to-br from-green-50 to-emerald-50">
                  ...
                  <CardContent className="p-8 space-y-6">
                    ...
                    {/* Action Buttons */}
                    <div className="flex flex-wrap gap-4 pt-6 border-t border-green-200">
                      <Button 
