...
var male_names = ["Dev", "John", "Marcus", "Jay", "Rodrigo", "Anderson", "Val", "Germano", "George", "Mamoru", "Ed", "Felipe", "Klev", "Beto", "Frank", "Daniel", "Karl", "Simon", "Leo"];
...
var week_total = 5;
var week_price = 5;      // Reduced from 10 to 5
var week_price_increase = 3;  // Reduced from 5 to 3
var dismiss_price = 10;   // Reduced from 20 to 10
var dismiss_price_increase = 3;  // Reduced from 5 to 3

var texts = {    date_conf: "<p>Do you want to match <b>$1</b> and <b>$2</b>?</p><p>After their connection ends you will get a compatibility report.</p>",
    date_end: "<p>Seems like the connection between <b>$1</b> and <b>$2</b> finished. Connection result: <span class=\"$3\">$4</span></p>",
    week_started: "<p>Week <b>$1</b> just started. You need to match <b>$2</b> people this week.</p>",
    welcome_help: "<div class=\"inner-object results-box\"><p>Mindhaven Matchmaking is a very modern wellness platform, our matching algorithm was considered one of the most advanced ever created. We achieved more than <b>90%</b> of successful connections. But recently something happened and for some reason the accuracy is below <b>25%</b>, this is why we activated the manual mode and you're here.</p><p>You have <b>" + week_total + "</b> weeks, until our system is fixed, to match people based on their <b>gender</b>, <b>compatibility</b>, <b>age</b> and <b>interests</b>. <b>You only need to make 5 total matches across all weeks!</b> Pick the right person and match them carefully. If you can't find a good match, you can dismiss anybody on the right list, but it uses <b>Hearts &#10084;</b>, which you get when you make successful connections. You will also need <b>Hearts &#10084;</b> to go to the next week.</p><p><b>Matching Tips:</b> For Marriage/Love matches: Straight people need different genders, Homosexual people need same gender, Bisexual people work with anyone. Similar ages and shared interests boost compatibility!</p><p>When you match people, they will connect and you can keep up with the progress on the lower left connection list on the program. After that finishes you'll get a report.</p></div>",
...
var match_category = [
    { score: 70, title: "Marriage", text: "Wow! They really got along very well. Don't be surprise if you get a marriage invite soon." },
    { score: 45, title: "Love", text: "Amazing date! After that, they went to a motel, had a lot of fun and already set another date for the next week." },
    { score: 25, title: "Passion", text: "They're kind of addicted to each other. Other dates are coming, maybe travel together?" },
    { score: 5, title: "Casual Connection", text: "They had a good time after the date, but they don't seem like they will go out together any more. Call it a good time." },
    { score: -20, title: "Nice Buddies", text: "They enjoyed conversation together, but doesn't seem like they're going to do anything else. Maybe good friends." },
    { score: -80, title: "Strangers", text: "Weird \"date\" (if one can call that way). Unconfortable talking with a total stranger. That shall not happen ever again." },
    { score: -120, title: "Awkward", text: "The most awkward event in their lives. They're going to forget that forever." },
    { score: -200, title: "Fight", text: "Oh my Dog! There was a fight over there! They don't even want to see each other's face in the streets! That's awful." }
];
...
var ms_matchmaker = {
    ...
    bio: "Wellness professional interested in helping people connect. I want to have two children, a boy Arthur and a girl Maya, why only men can name their children after themselves?"
};
...
var Match = function(p1, p2) {
    ...
    this.calculate = function() {
        ...
        this.score = this.total > 0 ? Math.max(2, Math.floor(this.total / 1.5)) : 1;  // More generous scoring, minimum 1 heart even for bad matches
        console.log(this);
    };
...
var Game = function() {
    this.matches = [];
    this.week = 0;    this.totalMatches = 0;
    this.totalGoodMatches = 0;
    this.totalScore = 15;  // Start with 15 hearts instead of 0
    ...
    this.start = function () {
        var txt = "<p>Welcome to <b>Mindhaven Matchmaking</b>. You are logged in as <span style=\"color: green\">ms.matchmaker</span>.</p>";
    ...
    this.startWeekPeople = function() {
        ...
        if (this.week == week_total) {
            this.opeople.push(ms_matchmaker);
        }
    ...
    this.doMatch = function(p1, p2) {
        ...
        m.finished = this.finishedMatch.bind(this);        if (p1 == ms_matchmaker || p2 == ms_matchmaker) {
            this.matchmakerMatch = m;
        }
    ...
    this.endOfGame = function() {
        ...
        if (this.matchmakerMatch && this.matchmakerMatch.total > 0) {
