...
var texts = {    date_conf: "<p>Do you want to match <b>$1</b> and <b>$2</b>?</p><p>After their connection ends you will get a compatibility report.</p>",
    ...
    welcome_help: "<div class=\"inner-object results-box\"><p>Mindhaven Matchmaking is a very modern wellness platform, our matching algorithm was considered one of the most advanced ever created. We achieved more than <b>90%</b> of successful connections. But recently something happened and for some reason the accuracy is below <b>25%</b>, this is why we activated the manual mode and you're here.</p><p>You have <b>" + week_total + "</b> weeks, until our system is fixed, to match people based on their <b>gender</b>, <b>compatibility</b>, <b>age</b> and <b>interests</b>. Every week you will have to find a good match for the people in the left list of the Mindhaven Matchmaking program. Pick the right person on the right and match them. If you can't find a good match, you can dismiss anybody on the right list, but it uses <b>Hearts &#10084;</b>, which you get when you make successful connections. You will also need <b>Hearts &#10084;</b> to go to the next week. Don't worry - we've made it easier for you to succeed!</p><p>When you match people, they will connect and you can keep up with the progress on the lower left connection list on the program. After that finishes you'll get a report.</p></div>",
